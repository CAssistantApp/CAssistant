.class public com/example/app/database/AppDatabase;
.super Landroid/database/sqlite/SQLiteOpenHelper;
.source "AppDatabase.java"

.field private static final DATABASE_NAME:Ljava/lang/String; = "appdatabase.db"
.field private static final DATABASE_VERSION:I = 0x3
.field private static INSTANCE:Lcom/example/app/database/AppDatabase;

.method private constructor <init>(Landroid/content/Context;)V
    .registers 5
    sget-object v0, Lcom/example/app/database/AppDatabase;->DATABASE_NAME:Ljava/lang/String;
    const/4 v1, 0x0
    sget v2, Lcom/example/app/database/AppDatabase;->DATABASE_VERSION:I
    invoke-direct {p0, p1, v0, v1, v2}, Landroid/database/sqlite/SQLiteOpenHelper;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V
    return-void
.end method

.method public static getInstance(Landroid/content/Context;)Lcom/example/app/database/AppDatabase;
    .registers 3
    sget-object v0, Lcom/example/app/database/AppDatabase;->INSTANCE:Lcom/example/app/database/AppDatabase;
    if-nez v0, :cond_13
    const-class v0, Lcom/example/app/database/AppDatabase;
    monitor-enter v0
    :try_start_7
    sget-object v1, Lcom/example/app/database/AppDatabase;->INSTANCE:Lcom/example/app/database/AppDatabase;
    if-nez v1, :cond_11
    new-instance v1, Lcom/example/app/database/AppDatabase;
    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;
    move-result-object v2
    invoke-direct {v1, v2}, Lcom/example/app/database/AppDatabase;-><init>(Landroid/content/Context;)V
    sput-object v1, Lcom/example/app/database/AppDatabase;->INSTANCE:Lcom/example/app/database/AppDatabase;
    :cond_11
    monitor-exit v0
    goto :goto_13
    :catch_10
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
    invoke-virtual {p0, p1}, Lcom/example/app/database/AppDatabase;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    return-void
.end method

.method public insertUser(Landroid/content/ContentValues;)J
    .registers 6
    invoke-virtual {p0}, Lcom/example/app/database/AppDatabase;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public queryUser(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    .registers 12
    invoke-virtual {p0}, Lcom/example/app/database/AppDatabase;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    move-result-object v0
    const-string v1, "users"
    const/4 v2, 0x0
    const/4 v5, 0x0
